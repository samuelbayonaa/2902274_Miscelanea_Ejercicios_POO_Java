...
public class main{
  public static void main(String[] args) {
    ...
    switch (mis) {
        ...
        System.out.print("Ingrese el valor del Euro: ");
        d1 = scr.nextDouble();
        ...
        System.out.print("Ingrese el valor de los cuadrados: ");
        d1 = scr.nextDouble();
        ...
        System.out.println("La longitud del Circulo es: " + d2);
        d3 = ejercicios.areaCirculo(d1);
        System.out.println("EL área del Circulo es: " + d3);
        ...
        System.out.println("2.6 Definir suma si algun valor es negativo y si no multiplicar.");
        System.out.print("Ingrese numero A: ");
        d1 = scr.nextDouble();
        System.out.print("Ingrese numero B: ");
        d2 = scr.nextDouble();
        resultado = ejercicios.sumaOmultiAyB(d1, d2);
        System.out.println("" + resultado);
